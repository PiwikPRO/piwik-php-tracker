...
class PiwikTracker
{
    ...
    {
        // NOTE: If the cookie name is changed, we must also update the method in ppms.js with the same name.
        $hash = substr(
            sha1(
     ...
     * @return string URL to ppms.php with all parameters set to track the pageview
     */
     ...
     * @param int $idGoal Id Goal to record a conversion
     * @param float $revenue Revenue for this conversion
     * @return string URL to ppms.php with all parameters set to track the goal conversion
     */
     ...
     * @param string $actionUrl URL of the download or outlink
     * @param string $actionType Type of the action: 'download' or 'link'
     * @return string URL to ppms.php with all parameters set to track an action
     */
    ...
    protected function getCookieMatchingName($name)
    {
        ...
        // Piwik cookie names use dots separators in ppms.js,
    ...
    /**
     * Sets the first party cookies as would the ppms.js
     ...
     *
     * This replicates the ppms.js tracker algorithms for consistency and better accuracy.
     *
     * @param $cookieName
     * @param $cookieValue
     * @param $cookieTTL
